...
#define MHD_UPGR_TRNSF_RESULT_FLAG_SENT                         0x40
#define MHD_UPGR_TRNSF_RESULT_FLAG_RECV                         0x80
#define MHD_UPGR_TRNSF_RESULT_FLAG_OK                           0x1
#define MHD_UPGR_TRNSF_RESULT_FLAG_ABORTED_BY_TIMEOUT           0x8
#define MHD_UPGR_TRNSF_RESULT_FLAG_ABORTED_BY_APP               0x10
#define MHD_UPGR_TRNSF_RESULT_FLAG_ABORTED_BY_REMOTE_DISCNT     0x18
#define MHD_UPGR_TRNSF_RESULT_FLAG_ABORTED_BY_NET_ERR           0x20

enum MHD_UpgrTransferResult
{
  MHD_UPGR_TRNSF_RESULT_SENT_OK =
      MHD_UPGR_TRNSF_RESULT_FLAG_SENT | MHD_UPGR_TRNSF_RESULT_FLAG_OK,

  MHD_UPGR_TRNSF_RESULT_SEND_ABORTED_BY_TIMEOUT =
      MHD_UPGR_TRNSF_RESULT_FLAG_SENT | MHD_UPGR_TRNSF_RESULT_FLAG_ABORTED_BY_TIMEOUT,
  MHD_UPGR_TRNSF_RESULT_SEND_ABORTED_BY_APP =
      MHD_UPGR_TRNSF_RESULT_FLAG_SENT | MHD_UPGR_TRNSF_RESULT_FLAG_ABORTED_BY_APP,
  MHD_UPGR_TRNSF_RESULT_SEND_ABORTED_BY_REMOTE_DISCNT =
      MHD_UPGR_TRNSF_RESULT_FLAG_SENT | MHD_UPGR_TRNSF_RESULT_FLAG_ABORTED_BY_REMOTE_DISCNT,
  MHD_UPGR_TRNSF_RESULT_SEND_ABORTED_BY_NET_ERR =
      MHD_UPGR_TRNSF_RESULT_FLAG_SENT | MHD_UPGR_TRNSF_RESULT_FLAG_ABORTED_BY_NET_ERR,

  MHD_UPGR_TRNSF_RESULT_RECV_OK =
      MHD_UPGR_TRNSF_RESULT_FLAG_RECV | MHD_UPGR_TRNSF_RESULT_FLAG_OK,

  MHD_UPGR_TRNSF_RESULT_RECV_ABORTED_BY_TIMEOUT =
      MHD_UPGR_TRNSF_RESULT_FLAG_RECV | MHD_UPGR_TRNSF_RESULT_FLAG_ABORTED_BY_TIMEOUT,
  MHD_UPGR_TRNSF_RESULT_RECV_ABORTED_BY_APP =
      MHD_UPGR_TRNSF_RESULT_FLAG_RECV | MHD_UPGR_TRNSF_RESULT_FLAG_ABORTED_BY_APP,
  MHD_UPGR_TRNSF_RESULT_RECV_ABORTED_BY_REMOTE_DISCNT =
      MHD_UPGR_TRNSF_RESULT_FLAG_RECV | MHD_UPGR_TRNSF_RESULT_FLAG_ABORTED_BY_REMOTE_DISCNT,
  MHD_UPGR_TRNSF_RESULT_RECV_ABORTED_BY_NET_ERR =
      MHD_UPGR_TRNSF_RESULT_FLAG_RECV | MHD_UPGR_TRNSF_RESULT_FLAG_ABORTED_BY_NET_ERR
};
