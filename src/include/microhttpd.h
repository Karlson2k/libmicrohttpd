...
#define MHD_UPGR_FLAG_ABORTED_BY_REMOTE            0x18
...
enum MHD_UpgrTransferResult
{
  ...
  MHD_UPGR_TRNSF_RESULT_SEND_ABORTED_BY_REMOTE =
      MHD_UPGR_TRNSF_RESULT_FLAG_SENT | MHD_UPGR_FLAG_ABORTED_BY_REMOTE,
  ...
  MHD_UPGR_TRNSF_RESULT_RECV_ABORTED_BY_REMOTE =
      MHD_UPGR_TRNSF_RESULT_FLAG_RECV | MHD_UPGR_FLAG_ABORTED_BY_REMOTE,
...
enum MHD_UpgrTerminationType
{
  ...
  MHD_UPGR_TERMINATION_BY_NET_ERR = MHD_UPGR_FLAG_ABORTED_BY_NET_ERR /* Network error or hard disconnect by remote peer. */
};
