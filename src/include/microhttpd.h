...
#define MHD_UPGR_FLAG_ABORTED_BY_REMOTE_DISCNT     0x18
#define MHD_UPGR_FLAG_ABORTED_BY_NET_ERR           0x20
...
enum MHD_UpgrTransferResult
{
  ...
  MHD_UPGR_TRNSF_RESULT_SEND_ABORTED_BY_TIMEOUT =
      MHD_UPGR_TRNSF_RESULT_FLAG_SENT | MHD_UPGR_FLAG_ABORTED_BY_TIMEOUT,
  MHD_UPGR_TRNSF_RESULT_SEND_ABORTED_BY_APP =
      MHD_UPGR_TRNSF_RESULT_FLAG_SENT | MHD_UPGR_FLAG_ABORTED_BY_APP,
  MHD_UPGR_TRNSF_RESULT_SEND_ABORTED_BY_REMOTE_DISCNT =
      MHD_UPGR_TRNSF_RESULT_FLAG_SENT | MHD_UPGR_FLAG_ABORTED_BY_REMOTE_DISCNT,
  MHD_UPGR_TRNSF_RESULT_SEND_ABORTED_BY_NET_ERR =
      MHD_UPGR_TRNSF_RESULT_FLAG_SENT | MHD_UPGR_FLAG_ABORTED_BY_NET_ERR,
  ...
  MHD_UPGR_TRNSF_RESULT_RECV_ABORTED_BY_TIMEOUT =
      MHD_UPGR_TRNSF_RESULT_FLAG_RECV | MHD_UPGR_FLAG_ABORTED_BY_TIMEOUT,
  ...
  MHD_UPGR_TRNSF_RESULT_RECV_ABORTED_BY_REMOTE_DISCNT =
      MHD_UPGR_TRNSF_RESULT_FLAG_RECV | MHD_UPGR_FLAG_ABORTED_BY_REMOTE_DISCNT,
  MHD_UPGR_TRNSF_RESULT_RECV_ABORTED_BY_NET_ERR =
      MHD_UPGR_TRNSF_RESULT_FLAG_RECV | MHD_UPGR_FLAG_ABORTED_BY_NET_ERR,
...
enum MHD_UpgrTerminationType
{
  ...
  MHD_UPGR_TERMINATION_BY_REMOTE_DISCNT = MHD_UPGR_FLAG_ABORTED_BY_REMOTE_DISCNT,
  MHD_UPGR_TERMINATION_BY_NET_ERR = MHD_UPGR_FLAG_ABORTED_BY_NET_ERR
};

typedef void (*MHD_UpgrTerminationCbk) \
    (struct MHD_UpgrHandleCbk *uh, enum MHD_UpgrTerminationType termination_type, void *cls);

_MHD_EXTERN int
MHD_upgr_register_termination_cbk (struct MHD_UpgrHandleCbk *uh, MHD_UpgrTerminationCbk callback, void *cls);

/* TODO: IMPLEMENT UPGRADE TIMEOUT SETTING. */
