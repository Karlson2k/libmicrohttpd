 ...
 */
  ...
  int MHD_tls_set_default_priority (MHD_gnutls_priority_t *, const char *priority,
                                    const char **err_pos);
...
/* get the currently used protocol version */
  enum MHD_GNUTLS_Protocol MHD__gnutls_protocol_get_version (MHD_gtls_session_t
                                                            session);

  const char *MHD__gnutls_protocol_get_name (enum MHD_GNUTLS_Protocol version);
 ...
 */
  ...
  extern void
    MHD_gtls_global_set_mem_functions (MHD_gnutls_alloc_function gt_alloc_func,
 ...
 */
  typedef ssize_t (*MHD_gtls_pull_func) (MHD_gnutls_transport_ptr_t, void *,
                                         size_t);
  typedef ssize_t (*MHD_gtls_push_func) (MHD_gnutls_transport_ptr_t, const void *,
                                         size_t);
...
//
//  void MHD_gnutls_srp_free_client_credentials (MHD_gnutls_srp_client_credentials_t
//                                           sc);
//  int MHD_gnutls_srp_allocate_client_credentials (MHD_gnutls_srp_client_credentials_t
//                                              * sc);
//  int MHD_gnutls_srp_set_client_credentials (MHD_gnutls_srp_client_credentials_t res,
//                                         const char *username,
//                                         const char *password);
//
//  void MHD_gnutls_srp_free_server_credentials (MHD_gnutls_srp_server_credentials_t
//                                           sc);
//  int MHD_gnutls_srp_allocate_server_credentials (MHD_gnutls_srp_server_credentials_t
//                                              * sc);
//  int MHD_gnutls_srp_set_server_credentials_file (MHD_gnutls_srp_server_credentials_t
//                                              res, const char *password_file,
//                                              const char *password_conf_file);
//
//  const char *MHD_gnutls_srp_server_get_username (MHD_gtls_session_t session);
//
...
//
//  int MHD_gnutls_srp_base64_encode (const MHD_gnutls_datum_t * data, char *result,
//                                size_t * result_size);
//  int MHD_gnutls_srp_base64_encode_alloc (const MHD_gnutls_datum_t * data,
//                                      MHD_gnutls_datum_t * result);
//
//  int MHD_gnutls_srp_base64_decode (const MHD_gnutls_datum_t * b64_data, char *result,
//                                size_t * result_size);
//  int MHD_gnutls_srp_base64_decode_alloc (const MHD_gnutls_datum_t * b64_data,
//                                      MHD_gnutls_datum_t * result);
...
//
//  void MHD_gnutls_psk_free_client_credentials (MHD_gnutls_psk_client_credentials_t
//                                           sc);
//  int MHD_gnutls_psk_allocate_client_credentials (MHD_gnutls_psk_client_credentials_t
//                                              * sc);
//  int MHD_gnutls_psk_set_client_credentials (MHD_gnutls_psk_client_credentials_t res,
//                                         const char *username,
//                                         const MHD_gnutls_datum_t * key,
//                                         MHD_gnutls_psk_key_flags format);
//
//  void MHD_gnutls_psk_free_server_credentials (MHD_gnutls_psk_server_credentials_t
//                                           sc);
//  int MHD_gnutls_psk_allocate_server_credentials (MHD_gnutls_psk_server_credentials_t
//                                              * sc);
//  int MHD_gnutls_psk_set_server_credentials_file (MHD_gnutls_psk_server_credentials_t
//                                              res, const char *password_file);
//
//  const char *MHD_gnutls_psk_server_get_username (MHD_gtls_session_t session);
//
...
//                         size_t * result_size);
//  int MHD_gnutls_hex_decode (const MHD_gnutls_datum_t * hex_data, char *result,
//                         size_t * result_size);
//
//  void MHD_gnutls_psk_set_server_dh_params (MHD_gnutls_psk_server_credentials_t res,
//                                        MHD_gtls_dh_params_t dh_params);
//
//  void MHD_gnutls_psk_set_server_params_function (MHD_gnutls_psk_server_credentials_t
//                                              res,
//                                              MHD_gnutls_params_function * func);
  ...
  typedef int MHD_gnutls_certificate_client_retrieve_function (MHD_gtls_session_t,
                                                           const
                                                           MHD_gnutls_datum_t *
                                                           req_ca_rdn,
                                                           int nreqs,
  ...
  typedef int MHD_gnutls_certificate_server_retrieve_function (MHD_gtls_session_t,
                                                           MHD_gnutls_retr_st *);
  ...
  int MHD_gtls_pem_base64_encode (const char *msg,
                                  const MHD_gnutls_datum_t * data, char *result,
                                  size_t * result_size);
